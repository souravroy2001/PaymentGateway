...
const SidebarContext = React.createContext<SidebarContextProps>({} as SidebarContextProps);
...
function SidebarProvider({
  ...
  children,
  ...props
}: ComponentProps<"div"> & { defaultOpen?: boolean; open?: boolean; onOpenChange?: (open: boolean) => void; children?: React.ReactNode }) {
...
// Sidebar Component with proper Tailwind classes
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent data-sidebar="sidebar" data-slot="sidebar" data-mobile="true" className="bg-sidebar text-sidebar-foreground w-[var(--sidebar-width)] p-0 [&>button]:hidden" style={{ "--sidebar-width": SIDEBAR_WIDTH_MOBILE } as React.CSSProperties} side={side}>
...
// Export the remaining components as-is
export {
  Sidebar,
  SidebarProvider,
  SidebarTrigger,
