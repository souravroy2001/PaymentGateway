...
function Calendar({
  ...
  const cellSize = "2rem" // Set default cell size here, can be customized
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          "flex items-center justify-center h-[var(--cell-size)] w-full px-2",
        ...
        dropdown_root: cn(
          "relative border border-input rounded-md shadow-sm focus-within:ring-1 focus-within:ring-ring/50",
      ...
      components={{
        ...
        WeekNumber: ({ children, ...props }) => (
          <td {...props}>
            <div className="flex items-center justify-center text-center" style={{ width: cellSize, height: cellSize }}>
              {children}
            </div>
          </td>
        ),
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex aspect-square w-full min-w-[var(--cell-size)] flex-col gap-1 leading-none font-normal",
